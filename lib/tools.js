...
module.exports = (function () {
   ...
   * Result will not contain parent circular references unless keepParent is set
   * to true.
   * 
  ...
  function cloneTag(source, removeEmpty, keepParent) {
    ...
    function cloneArray(array) {
      ...
      array.forEach(function (item){
        resultArray.push(cloneObject(item));
      });
      return resultArray;
    }
    ...
    function cloneObject(object) {
      ...
      if (isArray(object)) {
        if (object.length) return cloneArray(object);
        return null;
      }
  ...
  /**
   * Removes starting and trailing single or double quotes from a string.
   * 
