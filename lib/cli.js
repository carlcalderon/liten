...
module.exports = (function () {
  ...
  args = [
    { shortFlag: 'h', longFlag: 'help',      description: 'help',                                             value: false   },
    { shortFlag: 'o', longFlag: 'output',    description: 'sets the output directory',                        value: '.'     },
    { shortFlag: 'e', longFlag: 'extension', description: 'sets the output file extension',                   value: '.html' },
    { shortFlag: 'p', longFlag: 'print',     description: 'print out the compiled html',                      value: false   },
    { shortFlag: 'r', longFlag: 'raw',       description: 'print out the tokens the lexer produces',          value: false   },
    { shortFlag: 't', longFlag: 'tokens',    description: 'print out the tokens the lexer/rewriter produces', value: false   },
    { shortFlag: 'n', longFlag: 'nodes',     description: 'print out the tree that the parser produces',      value: false   },
    { shortFlag: 'V', longFlag: 'verbose',   description: 'sets liten to be more elaborate',                  value: false   },
    { shortFlag: 'x', longFlag: 'xhtml',     description: 'if set, output will be xhtml compatible',          value: false   },
    { shortFlag: 'v', longFlag: 'version',   description: 'version',                                          value: false   }
  ];
