...
module.exports = (function () {
   ...
   * final product. Passing "raw=true" as an option will retirn the token stream
   * without cleaning from the rewriter.
  ...
  function tagToken() {
    ...
    if ((prev = peekBehind())) {
      if (!(/terminator|dent$/i.test(prev))) {
          return 0;
      }
    }
