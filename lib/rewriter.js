...
module.exports = (function () {
   ...
   * and whitespaces. All line-numbers are kept for backtracking.
  ...
  function terminatorRewrite() {
    ...
    if (token[0] == 'TERMINATOR') {
      ...
      while (eon = input[needle + count]) {
        ...
        if (WHITESPACE.test(eon[0]) || COMMENT.test(eon[0]) && !keepComments) {
          count++;
